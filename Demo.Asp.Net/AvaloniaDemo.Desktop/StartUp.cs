...
namespace AvaloniaDemo.Desktop
{
    ...
    public class LongRunningDetectionMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly TimeSpan _timeout;

        public LongRunningDetectionMiddleware(RequestDelegate next, TimeSpan timeout)
        {
            _next = next;
            _timeout = timeout;
        }
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            catch (OperationCanceledException) //when (cts.IsCancellationRequested)
            {
                ...
                await context.Response.WriteAsync("Request was cancelled due to timeout.");
            }
        }
    }
